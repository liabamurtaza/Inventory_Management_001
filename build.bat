...
"C:\Masm615\BIN\LINK.EXE" /SUBSYSTEM:CONSOLE data.obj main.obj menu.obj inventory.obj product.obj Irvine32.lib kernel32.lib user32.lib /LIBPATH:"C:\Masm615\LIB" /OUT:main.exe
echo.
echo Build Done!
pause
